...
export default function App() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setVacant(data.stats?.vacants);
            setOccupied(data.stats?.occupieds);
        } catch (err) {
    ...
    return (
        <div className="flex justify-center items-start min-h-screen w-screen bg-base-200 py-10 px-4 text-[#3F5371]">
            <div
                ...
                {imagePreview && (
                    <div
                        className="bg-base-100 p-2 rounded-lg border shadow-md max-h-[60svh] overflow-auto flex justify-center">
                        <img
                            src={imagePreview}
                            alt="Selected"
                ...
                {spots !== null &&
                    (() => {
                        ...
                        return (
                            <div
                                className="flex items-stretch gap-4 overflow-x-auto rounded-box border border-base-300 bg-base-100 p-4">
